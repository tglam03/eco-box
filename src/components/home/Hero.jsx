    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-dark text-background pt-16">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center py-20">
        ...
        <div className="lg:col-span-7 space-y-8 text-left">
          ...
          >
            <Link to="/collection">
              <button className="flex items-center space-x-2 bg-secondary text-dark hover:bg-background hover:scale-105 active:scale-95 transition-all duration-300 px-8 py-4 rounded-full font-semibold uppercase tracking-wider text-xs shadow-lg">
                <span>Khám Phá Bộ Sưu Tập</span>
                <ArrowRight className="w-4 h-4" />
              </button>
            </Link>
            <Link to="/passport/ECO-2025-0001">
              <button className="flex items-center space-x-2 border border-background/25 hover:border-secondary hover:bg-background/5 transition-all duration-300 px-8 py-4 rounded-full font-semibold uppercase tracking-wider text-xs">
        ...
        <div className="lg:col-span-5 flex justify-center lg:justify-end">
          ...
          >
            ...
            <div className="relative flex-grow rounded-[32px] overflow-hidden bg-dark flex flex-col items-center justify-center p-4 text-center">
              ...
              {/* Target Scan Box */}
              <div className="relative z-10 w-40 h-40 border-2 border-secondary/50 rounded-2xl flex items-center justify-center p-2 mb-6">
                {/* Scanner corners */}
              ...
              <div className="relative z-10 space-y-2">
                ...
                <div className="pt-4">
                  <span className="inline-block bg-primary/45 border border-primary/20 text-white text-[9px] px-3 py-1 rounded-full animate-bounce">
                    Quét thành công!
                  </span>
                </div>
              </div>
